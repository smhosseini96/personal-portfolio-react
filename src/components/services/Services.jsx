        ...
        <section className="services section" id="services">
            ...
            <div className="services__content">
                ...
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={() =>
                        toggleTab(2)}>View More<i className="uil uil-arrow-right services__button-icon"></i></span>
                ...
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={() =>
                        toggleTab(3)}>View More<i className="uil uil-arrow-right services__button-icon"></i></span>
